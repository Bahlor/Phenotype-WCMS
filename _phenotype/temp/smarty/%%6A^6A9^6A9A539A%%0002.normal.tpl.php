<?php /* Smarty version 2.6.25, created on 2012-06-15 05:45:58
         compiled from /var/www/vhosts/think-dev.de/dalatedensee/dynamisch/_phenotype/application/templates/page_templates/0002.normal.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/vhosts/think-dev.de/dalatedensee/dynamisch/_phenotype/application/templates/page_templates/0002.normal.tpl', 4, false),array('function', 'description_of_page', '/var/www/vhosts/think-dev.de/dalatedensee/dynamisch/_phenotype/application/templates/page_templates/0002.normal.tpl', 6, false),array('function', 'url_for_page', '/var/www/vhosts/think-dev.de/dalatedensee/dynamisch/_phenotype/application/templates/page_templates/0002.normal.tpl', 25, false),array('function', 'title_of_page', '/var/www/vhosts/think-dev.de/dalatedensee/dynamisch/_phenotype/application/templates/page_templates/0002.normal.tpl', 25, false),)), $this); ?>
<!DOCTYPE html>
<html lang="de">
<head>
 ...
 - DalatEdensee</title>
	<meta charset="utf-8" />
	<meta name="description" content ="<?php echo $this->_plugins['function']['description_of_page'][0][0]->description_of_page(array('pag_id' => $this->_tpl_vars['page']->id,'lng_id' => $this->_tpl_vars['page']->lng_id), $this);?>
"/>
...
<body>
	<header class="wrapper">
		<div class="container">
			<div class="grid_4">
				<a href="<?php echo $this->_plugins['function']['url_for_page'][0][0]->url_for_page(array('pag_id' => 1,'lng_id' => $this->_tpl_vars['page']->lng_id), $this);?>
" title="<?php echo $this->_plugins['function']['title_of_page'][0][0]->title_of_page(array('pag_id' => 1,'lng_id' => $this->_tpl_vars['page']->lng_id), $this);?>
