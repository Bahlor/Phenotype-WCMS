...
?>
   ...
   */
	...
	function form_checkbox($input, $bez, $text,$val)
	{
		$a = Array (PT_CON_FORM_CHECKBOX, $input, $bez, $text, $val);
		if ($this->formmode == 1)
		{
			$this->form[] = $a;
		} else
...
?>
             ...
             if(empty($val) &&	$val !== 0 && $a[4]==1) {	$val =	1;	}
             echo $myLayout->workarea_form_checkbox("", $name, $val, $a[3],$a[4]);
?>
             </p>
             </td>
             </tr>
