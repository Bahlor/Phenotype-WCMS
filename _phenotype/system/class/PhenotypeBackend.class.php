...
<table width="640" height="480" border="0" align="center" cellpadding="0" cellspacing="0" id="login">
  <tr>
    <td>
...
';
		...
		switch ($this->lay_nr)
		{
			default:
				$this->displayTopLine();
				echo '<table width="995" border="0" cellspacing="0" cellpadding="0"><tr><td width="30"class="whitespace">&nbsp;</td><td width="270" class="sidebar" valign="top">';

				echo $this->html_leftarea;

				echo '</td><td width="700" valign="top" id="content" class="main-content-frame">';
	...
	{
		?>
	<table width="680" id="main-content-frame" border="0" cellpadding="0" cellspacing="0">
      <tr>
