...
class PhenotypeImageStandard extends PhenotypeMediaObject
{
	...
	*/
	...
	function display($alt = NULL, $version = NULL)
	{
		...
		?><img src="<?php echo MEDIABASEURL . $this->physical_folder . "/" . $this->filename ?>" width="<?php echo $this->x ?>" height="<?php echo $this->y ?>" alt="<?php echo $alt ?>" title="<?php echo $alt ?>" <?php if ($this->align!=""){ ?> align="<?php echo $this->align ?>"<?php } ?><?php if ($this->class!=""){ ?> class="<?php echo $this->class ?>"<?php } ?><?php if ($this->style!=""){ ?> style="<?php echo $this->style ?>"<?php } ?> /><?php
	}
...
?><img src="<?php echo MEDIABASEURL . $this->physical_folder . "/" . $this->filename ?>" width="<?php echo $x ?>" height="<?php echo $y ?>" alt="<?php echo $alt ?>" title="<?php echo $alt ?>"  <?php if ($this->class!=""){ ?> class="<?php echo $this->class ?>"<?php } ?><?php if ($this->style!=""){ ?> style="<?php echo $this->style ?>"<?php } ?> /><?php
...
?><img src="<?php echo MEDIABASEURL . $this->physical_folder . "/" . $filename ?>" width="<?php echo $tx ?>" height="<?php echo $ty ?>" alt="<?php echo $alt ?>" title="<?php echo $alt ?>"  <?php
...
?>
   ...
   <?php
		...
		{
?><img src="<?php echo MEDIABASEURL . $this->physical_folder . "/" . $this->filename ?>" width="<?php echo $x ?>" height="<?php echo $y ?>" alt="<?php echo $alt ?>" title="<?php echo $alt ?>"  <?php
