...
<html lang="de">
<head>
	<title>#!#title#!# - Fashion Session</title>
	<meta charset="utf-8" />
	<link rel="canonical" href="http://www.fashion-session.de/dynamisch/htdocs/Galerie-Videos" />
	<meta name="description" content ="Der Wasserverband Kinzig (WVK) ist die schl&uuml;ssige Antwort der Region Main-Kinzig auf die Herausforderungen einer sich wandelnden Wasserwirtschaft."/>
<meta name="keywords" content= "Wasserverband Kinzig, Kinzigtalsperre, Hochwasserschutz, Trinkwasser, Regenerative Energien, Trinkwasserbeschaffung, Klimawandel, Geothermie, Photovoltaik, Energieeffizienz, Kinzig-Stausee" />
...
<body>
	<header>
		<div class="wrapper">
			<a href="/dynamisch/htdocs/" id="logo" title="Back to home"><img src="/dynamisch/htdocs/images/site/logo.png" width="266" height="89" alt="Fashion Session Logo" /></a>
			<nav>
				<ul>
					<ul>	<li><a href="/dynamisch/htdocs/Ueber-Uns" title="Gehe zu Über Uns">Über Uns</a>
		</li>
	<li><a href="/dynamisch/htdocs/Events" title="Gehe zu Events">Events</a>
		</li>
	<li class="active"><a href="/dynamisch/htdocs/Galerie-Videos" title="Gehe zu Galerie / Videos">Galerie / Videos</a>
		</li>
	<li><a href="/dynamisch/htdocs/Kontakt" title="Gehe zu Kontakt">Kontakt</a>
		</li>
</ul>
				</ul>
			</nav>
	...
	<li><a href="/dynamisch/htdocs/Kontakt" title="Gehe zu Kontakt">Kontakt</a>
							...
							<ul>
	<li><a href="/dynamisch/htdocs/AGB" title="Gehe zu AGB">AGB</a></li>
	<li><a href="/dynamisch/htdocs/Impressum" title="Gehe zu Impressum">Impressum</a></li>
</ul>
						</ul>
					</nav>
				</div>
				<div class="grid_5 push_1">
					<h4>Kontakt</h4>
					<form name="kontakt" method="post" action="" id="contact">
