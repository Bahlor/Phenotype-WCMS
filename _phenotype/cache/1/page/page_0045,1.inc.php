	...
	<header class="wrapper">
		<div class="container">
			...
			<div class="grid_8" id="navigation">
				...
				<div id="language">
					<a href="/dynamisch/htdocs/en/Imprint" title="English"><img src="/dynamisch/htdocs/images/site/flags/en.png" width="16" height="11" alt="English" /></a>
...
<img src="/dynamisch/htdocs/media/2/I1203120/000031.jpg" width="924" alt="" />
	...
	<section id="content" class="container">
		<div class="grid_12" id="breadcrumb">
			You are here: <a href="/dynamisch/htdocs/en/Imprint" title="Go to Imprint">Imprint</a>
		</div>
	...
	<li class="active"><a href="/dynamisch/htdocs/en/Imprint" title="Gehe zu Imprint">Imprint</a></li>
</ul>
				</div>
				<div class="grid_4">
					<h3>Contact Us</h3>
		...
		<div id="bottom_footer">
			<div class="container">
				...
				<div class="grid_3" id="socials">
					...
					<a href="https://twitter.com/share?url=/dynamisch/htdocs/en/Imprint" class="external social twitter">Twitter</a>
					<a href="http://www.youtube.com/dalatedensee" class="external social youtube">YouTube</a>
					<a href="http://del.icio.us/post?url=http://dalat.think-dev.de/dynamisch/htdocs/en/Imprint&title=#!#title#!#" class="external social delicious">Delicious</a></p>
				</div>
			</div>
		</div>
	</footer>
